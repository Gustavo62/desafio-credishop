...
class ProponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proponent" do
    assert_difference("Proponent.count") do
      post proponents_url, params: { proponent: { address_id: @proponent.address_id, birthday: @proponent.birthday, contact_id: @proponent.contact_id, cpf: @proponent.cpf, inss_discount: @proponent.inss_discount, name: @proponent.name, salary: @proponent.salary } }
    end
  ...
  test "should update proponent" do
    patch proponent_url(@proponent), params: { proponent: { address_id: @proponent.address_id, birthday: @proponent.birthday, contact_id: @proponent.contact_id, cpf: @proponent.cpf, inss_discount: @proponent.inss_discount, name: @proponent.name, salary: @proponent.salary } }
